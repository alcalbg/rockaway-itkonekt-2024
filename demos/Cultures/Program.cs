...
foreach (var culture in cultures)
{
	...
	try
	{
		...
		Console.Write(cultureInfo.Name.PadRight(32, ' '));
		Console.Write(123.45m.ToString("C", cultureInfo).PadRight(20));
		Console.Write(DateTime.Now.ToString("ddd dd MMM yyyy", cultureInfo));
		Console.WriteLine();
